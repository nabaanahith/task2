...
},{"core-js/shim":"../node_modules/core-js/shim.js","regenerator-runtime/runtime":"../node_modules/regenerator-runtime/runtime.js","core-js/fn/regexp/escape":"../node_modules/core-js/fn/regexp/escape.js"}],"assets/upvote.svg":[function(require,module,exports) {
module.exports = "/upvote.574501f2.svg";
},{}],"assets/downvote.svg":[function(require,module,exports) {
module.exports = "/downvote.e2679fc5.svg";
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  getNews().then(function () {
    var mupVote = document.querySelector('#upvote');
    mupVote.addEventListener('click', function (e) {
      //  debugger
      var counterElem = document.getElementById('counter' + this.attributes[3].nodeValue);
      var counterValue = parseInt(counterElem.textContent) + 1;
      counterElem.innerHTML = counterValue;
      localStorage.setItem('counter p', counterValue);
    });
    var mdVote = document.querySelector('#downvote');
    mdVote.addEventListener('click', function (e) {
      //  debugger
      var counterElem2 = document.getElementById('counter' + this.attributes[3].nodeValue);
      var counterValue2 = parseInt(counterElem2.textContent) - 1;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("https://newsapi.org/v2/everything?q=".concat(query, "&apiKey=978d6c3818ff431b8c210ae86550fb1f"));
...
function createArticle(article, i) {
  // debugger
  article.counter = 1;
  return " \n\n    <article id=\"".concat(i, "\">\n      <img width=\"124px\" height=\"124px\" src=\"").concat(article.urlToImage, "\" alt=\"\">\n      <div id=\"text\">\n        <h1>").concat(article.title, "</h1>\n        <p>").concat(article.description, "</p>\n        <time>").concat(article.publishedAt, "</time>\n      </div>\n      <div id=\"voter\">\n        <img src=\"").concat(require('./assets/upvote.svg'), "\" id=\"upvote\" alt=\"\" data-artice-id='").concat(i, "'>\n       \n\n        <div id=\"counter").concat(i, "\">").concat(article.counter, "</div>\n        <img src=\"").concat(require('./assets/downvote.svg'), "\" id=\"downvote\" alt=\"\" data-artice-id='").concat(i, "'>\n              </div>\n      <Script>\n       console.log('nabuu')\n      </Script>\n    </article>\n  ");
}
},{"babel-polyfill":"../node_modules/babel-polyfill/lib/index.js","./assets/upvote.svg":"assets/upvote.svg","./assets/downvote.svg":"assets/downvote.svg"}],"../../AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
